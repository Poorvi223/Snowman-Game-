...
function preload(){
 ...
 snowmanfallImage = loadImage("snowmanfall.png");
...
function draw(){
    ...
    if(gameState === PLAY){
        ...
        if(keyDown(UP_ARROW) && Snowman.y>200){
      ...
      createTree();
       ...
       reset.visible = false;
        ...
        Snowman.addImage(snowmanfallImage);
        Snowman.y = 330;
...
function createTree(){
    if(frameCount%150===0){
        ...
        tree.setCollider("rectangle",0,0,100,250);
        treeGroup.add(tree);
